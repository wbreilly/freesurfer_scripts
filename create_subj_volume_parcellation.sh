...
SUBJECTS_DIR=/Users/wbr/walter/fmri/sms_scan_analyses/crick_imac/glasser_2_3_18
...
# sh create_subj_volume_parcellation.sh -L subjects.txt -a HCP-MMP1  -d MMP1_native -m YES -f 1 -l 4
